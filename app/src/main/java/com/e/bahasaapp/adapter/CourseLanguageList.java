...
import com.e.bahasaapp.kursus.CourseActivity;
    ...
    public void onBindViewHolder(@NonNull final ListViewHolder holder, final int position) {
        ...
        holder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (position <= 2 ) {
                    //   detailActivity.putExtra("position", listLanguage.get(position));
                    Intent detailActivity = new Intent(context, CourseActivity.class);
